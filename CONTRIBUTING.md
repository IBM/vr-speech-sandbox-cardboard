...
repository](https://github.com/IBM/vr-speech-sandbox-cardboard).

A good way to familiarize yourself with the codebase and contribution process is
to look for and tackle low-hanging fruit in the [issue
tracker](https://github.com/IBM/vr-speech-sandbox-cardboard/issues). Before embarking on
...
issue](https://github.com/IBM/vr-speech-sandbox-cardboard/issues) before sending a pull
